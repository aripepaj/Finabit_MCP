...
async def oauth_metadata():
    return JSONResponse({
        ...
        "authorization_endpoint": "http://localhost:8010/oauth/authorize",
        "token_endpoint": "http://localhost:8010/oauth/token",
        "registration_endpoint": "http://localhost:8010/oauth/register",
